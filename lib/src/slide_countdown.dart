...
class SlideCountdown extends StatefulWidget {
  ...
  /// Show title day, house, minute, seconds down timer.
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, Duration duration, Widget? child) {
        ...
        final groupMinutesWidget = Container(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              minutesWidget,
        ...
        final groupSecondsWidget = Container(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              secondsWidget,
        ...
        final countdownSubTitle = Padding(
          padding: widget.padding,
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
        ...
        return DecoratedBox(
          ...
          child: widget.isSubTitle ? countdownSubTitle : countdown,
        );
      },
